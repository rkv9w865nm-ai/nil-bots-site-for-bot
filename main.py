✅ Согласовано принято: промокоды + пользователи → Firebase Firestore

Присылаю полный обновлённый main.py (замени файл целиком — так надёжнее, чем искать куски). Всё остальное (заказ, документы, тех. работы, админ-чаты) осталось как есть.
